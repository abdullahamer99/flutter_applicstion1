...
class FeacBookFeeds extends StatefulWidget {
  @override
  _FeacBookFeedsState createState() => _FeacBookFeedsState();
}
TextStyle _hastag = TextStyle(
color: Colors.orange);
class _FeacBookFeedsState extends State<FeacBookFeeds> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('FaceBookFeeds'),
        actions: <Widget>[
